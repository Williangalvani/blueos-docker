...
class NetworkManagerWifi(AbstractWifiManager):
    ...
    def start(self, loop: asyncio.AbstractEventLoop) -> None:
        ...
        self._tasks.append(loop.create_task(self._autoscan()))
        # self._tasks.append(loop.create_task(self._monitor_wifi_state()))
    ...
    async def enable_hotspot(self, save_settings: bool = True) -> bool:
        ...
        cmd = [
            ...
            # '-c', str(channel),  # Always specify channel
            # '--freq-band', '2.4'  # Always use 2.4GHz for channel 6
        ]
    ...
    def hotspot_credentials(self) -> WifiCredentials:
        return WifiCredentials(
            ssid=self._settings_manager.settings.hotspot_ssid or "blueosap",
    ...
    def configure(self, _args: Namespace) -> None:
        pass
